...
const IngredientItem : React.FC<IngredientItemProps> = (props) => {
    ...
    async function onSave(){
        await fetch(`/api/recipes/${props.recipeId}/recipe-ingredients/${props.ingredient.id}`, {
            method: 'POST',
        ...
        return (
            <Draggable
                ...
                <div ref={provided.innerRef}  {...provided.draggableProps}>
                    <div style={{display:'flex',flexDirection:'row', margin:' 0.5rem 0',alignItems:'center'}}>
                    <ItemWrapper>
                        <div style={{height:"24px"}} {...provided.dragHandleProps}><AlignJustify/></div>
                        <InlineInput type="text" value={freeform} onChange={(e)=>setFreeform(e.target.value)}/>
                        {props.ingredient.id &&
                            <span>
    ...
    return (
        <span>{props.ingredient.freeform}</span>
    )
}
